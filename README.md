...
Infrastructure as Code and hands-on tutorials for AI and ML work on AWS.

Published in [AI & ML Human Training/Coaching](https://medium.com/ai-ml-human-training-coaching) on Medium.
...
* **[🧬 AI-ML on AWS #1 — Get Your Local Machine Ready for AI Work Inside AWS](https://medium.com/ai-ml-human-training-coaching/ai-ml-on-aws-1-get-your-local-machine-ready-for-ai-work-inside-aws-c3836e1fc8d1)** — The pre-flight checklist every developer needs before writing a single line of IaC.
...
```
aiml-on-aws/
├── ai-dev-server/   # CDK stack — EC2 AI Dev Server (Blog #2)
└── setup/           # Local machine setup scripts (Blog #1)
```
